...
class WiThrottle {
  ...
  private: 
    ...
    ~WiThrottle();
      ...
      static const int HEARTBEAT_SECONDS=1; // heartbeat at 4secs to provide messaging transport
      static const int ESTOP_SECONDS=4;     // eStop if no incoming messages for more than 8secs
